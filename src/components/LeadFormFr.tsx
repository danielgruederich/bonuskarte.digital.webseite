...
export default function LeadFormFr({ niche, arr }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <p className="text-xs tracking-[0.2em] uppercase text-white/55 mb-1">2 champs requis · 30 secondes</p>
      ...
      <a
        ...
        className="w-full group flex items-center justify-center gap-3 border border-[#25D366]/30 hover:border-[#25D366]/60 text-white/70 hover:text-white px-6 py-3.5 text-xs font-medium tracking-[0.15em] uppercase transition-all"
      >
      ...
      <p className="text-xs tracking-widest uppercase text-center text-white/40">
