...
Aber eine Eisflatrate? Jeden Tag eine Kugel für einen festen Monatspreis?
...
Diese Menschen kommen nicht einmal im Monat. Sie kommen jeden Tag. Oder könnten es — wenn du ihnen einen Grund gibst.

**Der Grund: Eine Eisflatrate.**
...
1. Dein Kunde installiert die Community Card in seine Apple Wallet oder Google Wallet
2. Er wählt das Abo — zum Beispiel „Eisflatrate: 1 Kugel pro Tag, 29€/Monat"
3. Stripe zieht den Betrag automatisch jeden Monat ein
4. Beim Besuch scannst du den Code — das System prüft, ob heute schon eingelöst wurde
5. Kugel rüber, fertig
...
**Szenario:** Du gewinnst 50 Abo-Kunden in den ersten 3 Monaten.

| | Pro Monat | 6 Monate |
|---|---|---|
| Einnahmen (50 × 29€) | 1.450€ | 8.700€ |
| Kosten pro Kugel (~0,50€) | ~750€* | ~4.500€* |
| **Gewinn** | **~700€** | **~4.200€** |

*Basierend auf der Annahme, dass ein Abo-Kunde durchschnittlich an 50 % der Tage einlöst — das ist der realistische Wert. Nicht jeder kommt jeden Tag.*
...
**1. Studenten lieben Flatrates.** Die Uni Köln ist um die Ecke. Studenten verstehen Abo-Modelle — sie zahlen für Spotify, Netflix, das Semesterticket. Eine Eisflatrate passt in ihre Welt. 29 Euro im Monat für jeden Tag eine Kugel? Für einen Studenten, der sowieso dreimal die Woche Eis isst, ist das ein No-Brainer.

**2. Familien am Stadtwald kommen regelmäßig.** Wer mit Kindern im Stadtwald spazieren geht, braucht danach ein Eis. Das ist kein Wunsch, das ist ein Naturgesetz. Mit der Flatrate wird aus dem „Können wir ein Eis?" ein „Klar, wir haben ja die Karte." Kein Diskutieren, kein Portemonnaie-Zücken. Einfach scannen und genießen.
...
Das spricht sich rum. Erst bei den Kunden. Dann bei den Nachbarn. Dann in der WhatsApp-Gruppe des Viertels. Und irgendwann steht der Kölner Stadt-Anzeiger vor deiner Tür und will eine Story.

„Eisdiele in Sülz bietet Flatrate an — eine Kugel pro Tag für 29 Euro im Monat."

**Das ist die Art von Schlagzeile, für die andere Betriebe Tausende an PR-Agenturen zahlen.** Du bekommst sie kostenlos — weil die Idee stark genug ist.
...
Du bestimmst den Preis. 19 Euro für Studenten, 29 Euro für alle, 39 Euro für die Premium-Variante mit zwei Kugeln pro Tag. Du kennst dein Veedel besser als jeder Berater. Setz den Preis, der sich richtig anfühlt — und pass ihn an, wenn du siehst, was funktioniert.

**„Ich weiß nicht, ob meine Kunden das mitmachen."**
...
3. **Stripe verbinden** — einmal einrichten, läuft dann automatisch
